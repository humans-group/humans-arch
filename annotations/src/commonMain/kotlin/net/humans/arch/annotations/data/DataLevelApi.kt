package net.humans.arch.annotations.data

/**
 * Data level API annotation.
 *
...
@RequiresOptIn(
    ...
    message = "This is an experimental API. \n" +
        ...
        "If you want to use this API just add @OptIn(DataLevelApi::class)."
)
annotation class DataLevelApi
